...
data <- readRDS("data/exp2_data.rds")
...
# add expertise only for confidcence
fit8 <- brm(bf(
  confidence ~ 
    viz * expertise +
    viz * p_lt0.05 * logit_p + 
...
saveRDS(kfold1, file = "experiment1/results/kfold1.rds")
kfold2 <- kfold(fit2, folds = folds)
saveRDS(kfold2, file = "experiment1/results/kfold2.rds")
kfold3 <- kfold(fit3, folds = folds)
saveRDS(kfold3, file = "experiment1/results/kfold3.rds")
kfold4 <- kfold(fit4, folds = folds)
saveRDS(kfold4, file = "experiment1/results/kfold4.rds")
kfold5 <- kfold(fit5, folds = folds)
saveRDS(kfold5, file = "experiment1/results/kfold5.rds")
kfold6 <- kfold(fit6, folds = folds)
saveRDS(kfold6, file = "experiment1/results/kfold6.rds")
kfold7 <- kfold(fit7, folds = folds)
saveRDS(kfold7, file = "experiment1/results/kfold7.rds")
kfold8 <- kfold(fit8, folds = folds)
saveRDS(kfold8, file = "experiment1/results/kfold8.rds")
